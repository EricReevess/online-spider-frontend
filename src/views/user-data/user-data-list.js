...
const UserDataList = () => {
  ...
  const columns = [{
    ...
    title: '创建时间', dataIndex: 'create_time', key: 'create_time', render:(text) => new Date(text).toLocaleString()
  },{
    title: '完成时间', dataIndex: 'grabTime', key: 'grabTime', render:(text) => new Date(text).toLocaleString()
  },{
